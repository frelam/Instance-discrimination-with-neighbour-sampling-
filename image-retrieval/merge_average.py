...
import os
import glob
from merge_query import Query

os.environ["CUDA_VISIBLE_DEVICES"] = "0"

# read in indexed images' feature vectors and corresponding image names
h5f1 = h5py.File('/home/omnisky/image-retrieval/featureCNN_Resnet50_their_GAN.t7.h5', 'r')
# feats = h5f['dataset_1'][:]
...
h5f2 = h5py.File('/home/omnisky/image-retrieval/featureCNN_Resnet50_us_GAN_m=4096_2.1.1.h5', 'r')
# feats = h5f['dataset_1'][:]
...
for j in range(1,36):
    for i in range(1,(queryNumeber[j-1]+1)):
        ...
        rank2, AP = q.query(feats1, feats2, imgNames1,queryDir, label, N, Nrel, Nrel_all, query_path)
        if min > rank2:
            min = rank2
            min_num = i
            AP_max = AP
...
MAP = MAP / 35.0
print('MAP =',MAP)
print('featureCNN_Resnet50_us_GAN.h5')
'''
